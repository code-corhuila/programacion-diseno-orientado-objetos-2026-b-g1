# Programacion y Diseno Orientado a Objetos - 2026-B
...
| --- | --- |
| **Grupo** | 1 |
| **Horario** | Martes 6:00 a. m. - 6:50 a. m.<br>Jueves 8:20 p. m. - 10:00 p. m. |
| **Aula** | B2-210 |
| **Semestre** | 2026-B |
...
```bash
git clone https://github.com/<tu-usuario>/programacion-diseno-orientado-objetos-2026-b-g1.git
cd programacion-diseno-orientado-objetos-2026-b-g1
# edita NN-week/hu-status/README.md o agrega tus archivos ahi
git add . && git commit -m "Entrega semana NN" && git push
```

Material interactivo (OVAs): https://code-corhuila.github.io/ova-web/2026-B/poo/
